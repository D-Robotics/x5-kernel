...
#ifndef __HOBOT_ETH_MMC_H_
#define __HOBOT_ETH_MMC_H_ /*PRQA S 0603*/
...
void hobot_eth_mmc_read(void *__iomem addr, struct hobot_counters *mmc);
void hobot_eth_mmc_intr_all_mask(void *__iomem addr);
void hobot_eth_mmc_ctrl(void *__iomem addr, unsigned int mode);
