						   ...
						   const char *page, size_t len)
{
	...
	/* len - 1 to skip '\n'(0xa) character,
	 * otherwise, it will contains 0xa like below:
	 *  'H',  '2',  '6',  '4', 0x0a, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71
	 *
	 *  which is wrong...it should be,
	 *  'H',  '2',  '6',  '4', 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71
	 *
	 *  BTW, all GUID format's following id is sampe.
	 *  example:
	...
	memcpy(ch->desc.guidFormat, page,
	       min(sizeof(ch->desc.guidFormat), len - 1));
