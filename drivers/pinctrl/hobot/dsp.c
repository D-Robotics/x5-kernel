...
#define ST_DSP_UART5_TXD BIT(24)
#define ST_DSP_UART5_RXD BIT(16)
#define ST_DSP_I2C5_SDA  BIT(8)
#define ST_DSP_I2C5_SCL  BIT(0)
...
#define DS_DSP_UART5_TXD 25
#define DS_DSP_UART5_RXD 17
#define DS_DSP_I2C5_SDA  9
#define DS_DSP_I2C5_SCL  1
...
#define PU_DSP_UART5_TXD BIT(31)
#define PU_DSP_UART5_RXD BIT(23)
#define PU_DSP_I2C5_SDA  BIT(15)
#define PU_DSP_I2C5_SCL  BIT(7)
...
#define PE_DSP_UART5_TXD BIT(30)
#define PE_DSP_UART5_RXD BIT(22)
#define PE_DSP_I2C5_SDA  BIT(14)
#define PE_DSP_I2C5_SCL  BIT(6)
...
#define PS_DSP_UART5_TXD BIT(29)
#define PS_DSP_UART5_RXD BIT(21)
#define PS_DSP_I2C5_SDA  BIT(13)
#define PS_DSP_I2C5_SCL  BIT(5)
...
static const struct horizon_pin_desc horizon_dsp_pins_desc[] = {
	_PIN(DSP_UART5_TXD, "dsp_uart5_txd", DSP_PINCTRL_0, INVALID_REG_DOMAIN, DS_DSP_UART5_TXD,
	     PE_DSP_UART5_TXD, PS_DSP_UART5_TXD, PU_DSP_UART5_TXD, INVALID_PULL_BIT,
	     ST_DSP_UART5_TXD, INVALID_MS_BIT),
	_PIN(DSP_UART5_RXD, "dsp_uart5_rxd", DSP_PINCTRL_0, INVALID_REG_DOMAIN, DS_DSP_UART5_RXD,
	     PE_DSP_UART5_RXD, PS_DSP_UART5_RXD, PU_DSP_UART5_RXD, INVALID_PULL_BIT,
	     ST_DSP_UART5_RXD, INVALID_MS_BIT),
	_PIN(DSP_I2C5_SDA, "dsp_i2c5_sda", DSP_PINCTRL_0, INVALID_REG_DOMAIN, DS_DSP_I2C5_SDA,
	     PE_DSP_I2C5_SDA, PS_DSP_I2C5_SDA, PU_DSP_I2C5_SDA, INVALID_PULL_BIT,
	     ST_DSP_I2C5_SDA, INVALID_MS_BIT),
	_PIN(DSP_I2C5_SCL, "dsp_i2c5_scl", DSP_PINCTRL_0, INVALID_REG_DOMAIN, DS_DSP_I2C5_SCL,
	     PE_DSP_I2C5_SCL, PS_DSP_I2C5_SCL, PU_DSP_I2C5_SCL, INVALID_PULL_BIT,
	     ST_DSP_I2C5_SCL, INVALID_MS_BIT),
