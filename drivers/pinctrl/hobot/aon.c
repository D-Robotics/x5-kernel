...
static const struct horizon_pin_desc horizon_aon_pins_desc[] = {
	_PIN(AON_GPIO0_PIN0,  "aon_gpio_pin0", AON_PINCTRL_0, INVALID_REG_DOMAIN, DS_AON_1,INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT6, PD_AON_BIT5, ST_AON_BIT0, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_GPIO0_PIN1,  "aon_gpio_pin1", AON_PINCTRL_0, INVALID_REG_DOMAIN, DS_AON_9,INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT14, PD_AON_BIT13, ST_AON_BIT8, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_GPIO0_PIN2,  "aon_gpio_pin2", AON_PINCTRL_0, INVALID_REG_DOMAIN, DS_AON_17,INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT22, PD_AON_BIT21, ST_AON_BIT16, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_GPIO0_PIN3,  "aon_gpio_pin3", AON_PINCTRL_0, INVALID_REG_DOMAIN, DS_AON_25,INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT30, PD_AON_BIT29, ST_AON_BIT24, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_GPIO0_PIN4,  "aon_gpio_pin4", AON_PINCTRL_1, INVALID_REG_DOMAIN, DS_AON_1, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT6, PD_AON_BIT5, ST_AON_BIT0, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_PMIC_EN,  "aon_pmic_en", AON_PINCTRL_2, INVALID_REG_DOMAIN, DS_AON_1, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT6, PD_AON_BIT5, ST_AON_BIT0, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_ENV_VDD,  "aon_env_vdd", AON_PINCTRL_2, INVALID_REG_DOMAIN, DS_AON_25, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT30, PD_AON_BIT29, ST_AON_BIT24, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_ENV_CNN0,  "aon_env_cnn0", AON_PINCTRL_3, INVALID_REG_DOMAIN, DS_AON_1, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT6, PD_AON_BIT5, ST_AON_BIT0, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_ENV_CNN1,  "aon_env_cnn1", AON_PINCTRL_3, INVALID_REG_DOMAIN, DS_AON_9, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT14, PD_AON_BIT13, ST_AON_BIT8, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_HW_RESETN,  "aon_hw_resetn", AON_PINCTRL_3, INVALID_REG_DOMAIN, DS_AON_17, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT22, PD_AON_BIT21, ST_AON_BIT16, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_RESETN_OUT,  "aon_reset_out", AON_PINCTRL_4, INVALID_REG_DOMAIN, DS_AON_1, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT6, PD_AON_BIT5, ST_AON_BIT0, INVALID_MS_BIT, AON_1V8),
	_PIN(AON_IRQ_OUT,  "aon_irq_out", AON_PINCTRL_4, INVALID_REG_DOMAIN, DS_AON_17, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_AON_BIT22, PD_AON_BIT21, ST_AON_BIT16, INVALID_MS_BIT, AON_1V8),
