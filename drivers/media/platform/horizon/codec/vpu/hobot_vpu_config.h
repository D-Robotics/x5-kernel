...
#define VPU_LOCK_BUSY_CHECK_TIMEOUT          (1000)
...
#else
#define WAVE521DEC_WORKBUF_SIZE			(1792*1024)	// 1784KB, algin 64K.
#define WAVE521ENC_WORKBUF_SIZE			(128*1024)
#define SIZE_WORK						(MAX_NUM_VPU_INSTANCE*(WAVE521DEC_WORKBUF_SIZE+WAVE521ENC_WORKBUF_SIZE))
#endif
