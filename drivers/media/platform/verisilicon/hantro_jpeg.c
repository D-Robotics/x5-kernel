...
static const unsigned char luma_q_table[] = {
	0x10, 0x0b, 0x0a, 0x10, 0x18, 0x28, 0x33, 0x3d, 0x0c, 0x0c, 0x0e, 0x13, 0x1a,
	0x3a, 0x3c, 0x37, 0x0e, 0x0d, 0x10, 0x18, 0x28, 0x39, 0x45, 0x38, 0x0e, 0x11,
	0x16, 0x1d, 0x33, 0x57, 0x50, 0x3e, 0x12, 0x16, 0x25, 0x38, 0x44, 0x6d, 0x67,
	0x4d, 0x18, 0x23, 0x37, 0x40, 0x51, 0x68, 0x71, 0x5c, 0x31, 0x40, 0x4e, 0x57,
	0x67, 0x79, 0x78, 0x65, 0x48, 0x5c, 0x5f, 0x62, 0x70, 0x64, 0x67, 0x63};

static const unsigned char chroma_q_table[] = {
	0x11, 0x12, 0x18, 0x2f, 0x63, 0x63, 0x63, 0x63, 0x12, 0x15, 0x1a, 0x42, 0x63,
	0x63, 0x63, 0x63, 0x18, 0x1a, 0x38, 0x63, 0x63, 0x63, 0x63, 0x63, 0x2f, 0x42,
...
static const u32 hw_reorder[] = {0, 8,	16, 24, 1, 9,  17, 25, 32, 40, 48, 56, 33, 41, 49, 57,
...
static void jpeg_scale_quant_table(unsigned char *file_q_tab, unsigned char *reordered_q_tab,
...
static void jpeg_set_quality(struct hantro_jpeg_ctx *ctx)
{
	...
	jpeg_scale_quant_table(ctx->buffer + LUMA_QUANT_OFF, ctx->hw_luma_qtable, luma_q_table,
			       scale);
	jpeg_scale_quant_table(ctx->buffer + CHROMA_QUANT_OFF, ctx->hw_chroma_qtable,
...
void hantro_jpeg_header_assemble(struct hantro_jpeg_ctx *ctx)
{
	...
	memcpy(buf + HUFF_CHROMA_DC_OFF, chroma_dc_table, sizeof(chroma_dc_table));
	memcpy(buf + HUFF_CHROMA_AC_OFF, chroma_ac_table, sizeof(chroma_ac_table));
