...
int hantro_mpeg2_dec_init(struct hantro_ctx *ctx)
{
	...
	ctx->mpeg2_dec.qtable.cpu  = dma_alloc_coherent(vpu->dev, ctx->mpeg2_dec.qtable.size,
							&ctx->mpeg2_dec.qtable.dma, GFP_KERNEL);
...
void hantro_mpeg2_dec_exit(struct hantro_ctx *ctx)
{
	...
	dma_free_coherent(vpu->dev, ctx->mpeg2_dec.qtable.size, ctx->mpeg2_dec.qtable.cpu,
