...
static void set_params(struct hantro_ctx *ctx, struct vb2_v4l2_buffer *src_buf)
{
	...
	reg = VDPU_REG_DEC_ADV_PRE_DIS(0) | VDPU_REG_DEC_SCMD_DIS(0) | VDPU_REG_FILTERING_DIS(0) |
	      VDPU_REG_PIC_FIXED_QUANT(0) | VDPU_REG_DEC_LATENCY(0);
	...
	reg = VDPU_REG_DEC_STRENDIAN_E(1) | VDPU_REG_DEC_STRSWAP32_E(1) |
	      ...
	      VDPU_REG_DEC_OUT_ENDIAN(1) | VDPU_REG_DEC_IN_ENDIAN(0);
	...
	reg = VDPU_REG_START_CODE_E(1) | VDPU_REG_CH_8PIX_ILEAV_E(0) | VDPU_REG_RLC_MODE_E(0) |
	      ...
	      VDPU_REG_PIC_TOPFIELD_E(
		      !(dec_param->flags & V4L2_H264_DECODE_PARAM_FLAG_BOTTOM_FIELD)) |
	      ...
	      VDPU_REG_PICORD_COUNT_E(sps->profile_idc > 66) | VDPU_REG_DEC_TIMEOUT_E(1) |
	      VDPU_REG_DEC_CLK_GATE_E(1);
	vdpu_write_relaxed(vpu, reg, VDPU_SWREG(57));

	reg = VDPU_REG_PRED_BC_TAP_0_0(1) | VDPU_REG_PRED_BC_TAP_0_1((u32)-5) |
	...
	reg = VDPU_REG_FILT_CTRL_PRES(pps->flags &
