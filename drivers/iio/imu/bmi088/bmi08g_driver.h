...
#ifndef BMI08G_DRIVER_H
#define BMI08G_DRIVER_H
...
#define SENSOR_NAME	  "bmi088_gyro"
...
/**
 *	struct bmi08g_client_data - Client structure which holds sensor-specific
 *	information.
 */
struct bmi08g_client_data {
...
/**
 * bmi08g_probe - This is the probe function for bmi08g sensor.
 ...
 */
int bmi08g_probe(struct iio_dev *data_iio_private);
 ...
 * * negative value -> Error
 */
int bmi08g_remove(struct iio_dev *data_iio_private);

#ifdef __cplusplus
}
#endif

#endif /* BMI08G_DRIVER_H_	*/
