...
/**
 *	struct bmi08_client_data - Client structure which holds sensor-specific
 *	information.
 */
struct bmi08_client_data {
 ...
 */
int bmi08_probe(struct iio_dev *data_iio_private);
 ...
 * * negative value -> Error
 */
int bmi08_remove(struct iio_dev *data_iio_private);
