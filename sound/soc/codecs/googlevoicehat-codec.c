/*
 * Driver for the Google voiceHAT audio codec for Raspberry Pi and RDK X5.
 *
				   ...
				   struct snd_soc_dai *dai)
{
    ...
    dev_dbg(dai->dev, "Playback Active %d", substream->stream == SNDRV_PCM_STREAM_PLAYBACK);
    dev_dbg(dai->dev, "Capture Active  %d", substream->stream == SNDRV_PCM_STREAM_CAPTURE);
...
MODULE_DESCRIPTION("Google voiceHAT Codec driver with additional modifications");
MODULE_AUTHOR("Peter Malkin <petermalkin@google.com>, FuHua Wang <fuhua.wang@d-robotics.cc>");
